...
export default function SettingsPage_V2() {
    ...
    return (
        <div className="relative w-full h-full flex flex-col items-center justify-center bg-[#3a3a3a] overflow-hidden " style={{ backgroundImage: 'radial-gradient(#4f4f4f 1px, transparent 1px)', backgroundSize: '1rem 1rem' }}>
            ...
            <div className="w-full flex justify-center items-center p-8 overflow-x-auto scrollbar-thin scrollbar-thumb-gray-500 scrollbar-track-gray-700">
                {themes.map(theme => (
                    <ThemeObject
                        key={theme.id}
                        theme={theme}
